...
export const glassBox =
  "relative bg-white/20 backdrop-blur-md rounded-3xl shadow-xl overflow-hidden";

export const geometricOverlay = "relative p-8 md:p-16";

export const headerText =
  "text-4xl md:text-6xl font-extrabold tracking-tight text-gray-900";
...
export const booksPageStyles = {
  ...
  filterRow: "flex flex-wrap items-center justify-between mt-6 mb-8 gap-4",
  ...
  imageWrapper: "relative aspect-[3/4] mb-4 md:mb-6 overflow-hidden rounded-lg md:rounded-xl",
