    ...
    <footer className={styles.footer}>
      <div className={styles.container}>
        ...
        <div className={styles.copyrightWrap}>
            ...
            <a href=""//link of portfolio
            target='_blank' className='text-sm cursor-pointer text-gray-500 hover:text-purple-600'>
            Powered By {" "}<br />
            Tejas Raghunath Nikam
            </a>
